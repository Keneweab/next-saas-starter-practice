...
const TESTIMONIALS = [
  {
    ...
    author: {
      name: 'Clyde Edwards',
      title: 'Very Serious Woman',
      avatarUrl: '/testimonials/undraw_a-woman-avatar_ifsl.svg',
    },
  },
  {
    companyLogoUrl: '/testimonials/company-logo-2.svg',
    content: `It's really wonderful. I use AI product often. Thank You! AI product has really helped our business.`,
    author: {
      name: 'Jimmy Hunter',
      title: 'Sigma Male University Graduate',
      avatarUrl: '/testimonials/undraw_developer-avatar_f6ac.svg',
    },
  },
  {
    companyLogoUrl: '/testimonials/company-logo-3.svg',
    content: `Since I invested in RAG AI product I made over 100,000 dollars profits. It really saves me time and effort. saas product is exactly what our business has been lacking.`,
    author: {
      name: 'Marjorie Morgan',
      title: 'Chief Chad Officer',
      avatarUrl: '/testimonials/undraw_businesswoman-avatar_ktl2.svg',
    },
  },
];
